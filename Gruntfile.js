    ...
    concat: {
        basic: {
            src: [
                ...
                '<%= dirs.inputJS %>/fancybox3/jquery.fancybox.min.js',
                '<%= dirs.inputJS %>/my_script.js',
                '<%= dirs.inputJS %>/lazyload.min.js',
                '<%= dirs.inputJS %>/jssor/jssor.slider-25.2.0.min.js',
                '<%= dirs.inputJS %>/jssor/jssor_1_slider_init.js',

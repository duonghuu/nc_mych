...
<form name="supplier" id="validate" class="form" action="index.php?com=bannerqc&act=save<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" method="post" enctype="multipart/form-data">
  <div class="widget">
    ...
    <div class="formRow lang_hidden lang_vi active">
      ...
      <div class="mt10">
         <object width="" height="<?=_height_thumb?>"  codebase="http://active.macromedia.com/flash4/cabs/swflash.cab#version=4,0,0,0" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000">
             ...
             <embed style="max-width: 100%" src="<?=_upload_hinhanh.$item['photo_vi']?>" quality="High" pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" width="" height="<?=_height_thumb?>" scale="ExactFit"></embed>
            </object>
      </div>
      </div>
      <div class="clear"></div>
    ...
    <div class="formRow lang_hidden lang_en">
     ...
     <?php if($links_=='true'){?>
        <div class="formRow">
            ...
            <div class="formRight">
                <input type="text" id="link" name="link"  title="Nhập link liên kết cho hình ảnh" class="tipS" value="<?=@$item['link']?>" />
            </div>
            <div class="clear"></div>
        </div>
    <?php }  ?>

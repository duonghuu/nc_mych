  ...
  <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
    <thead>
      <tr>
        ...
        <td class="tb_data_small">Check danh mục</td>
        <!-- <td class="tb_data_small">Nổi bật</td> -->
        <td class="tb_data_small">Ẩn/Hiện</td>
		
	<!-- 	<td class="tb_data_small">ảnh quảng cáo Trái</td>
		
		<td class="tb_data_small">ảnh quảng cáo Phải</td> -->
    ...
    <tbody>
       ...
       <td>
        ...
        <td class="title_name_data">
         ...
         <td align="center">
          <a data-val2="table_<?=$_GET['com']?>_list" rel="<?=$items[$i]['danhmuc']?>" data-val3="danhmuc" class="diamondToggle <?=($items[$i]['danhmuc']==1)?"diamondToggleOff":""?>" data-val0="<?=$items[$i]['id']?>" ></a> 
        </td>
       ...
       <!--  <td align="center">
		...
		<!-- 
		 <td class="title_name_data">
            <a href="index.php?com=product&act=man_photo&idc=<?=$items[$i]['id']?><?php if($_REQUEST['type']!='') echo'&type=quangcaotrai';?>" class="tipS SC_bold">Hình ảnh</a>
        </td>
       
	   <td class="title_name_data">
            <a href="index.php?com=product&act=man_photo&idc=<?=$items[$i]['id']?><?php if($_REQUEST['type']!='') echo'&type=quangcaophai';?>" class="tipS SC_bold">Hình ảnh</a>
        </td> -->

    ...
    <div class="khung">
      <div class="thanh_title"><h2><?=$title_detail?></h2></div><div class="clear"></div>
        <div>
            ...
            ?>
            <div class="sp_form <?php if(($j+1)%4==0){ echo 'last';}?>" >
                <div class="product_images">
                    <div class="sp_xemnhanh" data-rel="<?=$product[$j]['giaban']?>">
                        ...
                        <div class="addcart" data-rel="<?=$product[$j]['id']?>"><a href="gio-hang.html" title="Xem giỏ hàng"><img src="images/icon_cart.png" alt="Mua hàng" title="Xem giỏ hàng"></a>(<?php echo count($_SESSION['cart']); ?>) <span class="add_cart"  data-rel="<?=$product[$j]['id']?>">Mua hàng</span></div>
                    </div>
            ...
            <?php if(($j+1)%4==0) echo '<div class="clear" style="height:20px;"></div>'; ?>
            <?php } } ?>
        </div>
        <div class="clear"></div>
